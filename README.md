...
<p>
Make sure to use this link that will take you to the installation files needed to properly install osTicket. You should have this window open on your VM since all the downloads will be happening inside there.
</p>
<ul>
